...
export function ChapterHero() {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <img
          src="/chapter-3-hero.jpg"
          alt="Indigenous lands and modern nuclear resistance"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center space-y-8">
        <h1 className="font-serif text-5xl md:text-7xl font-bold text-foreground leading-tight text-balance animate-fade-in-up">
          Chapter 3 — Indigenous Resistance & Modern Fallout: The Struggle Continues
        </h1>
        ...
        <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed text-pretty max-w-4xl mx-auto animate-fade-in-up [animation-delay:200ms] opacity-0 [animation-fill-mode:forwards]">
          From sacred lands threatened by repositories to communities still living with contamination, the fight for
          environmental justice and Indigenous sovereignty remains urgent and unresolved.
        </p>
